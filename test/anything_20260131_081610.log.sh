...
# ═══════════════════════════════════════════════════════════════
# STEP 1: Check if doom is available via chocolate-doom or similar
# Generated: 2026-01-31 08:15:55
# ═══════════════════════════════════════════════════════════════
step1() {
  echo "=== Checking for Doom engines ==="
  ...
  command -v gzdoom &>/dev/null && echo "gzdoom: INSTALLED" || echo "gzdoom: NOT_INSTALLED"
  command -v freedoom &>/dev/null && echo "freedoom: INSTALLED" || echo "freedoom: NOT_INSTALLED"
  echo "=== Checking pacman for available doom packages ==="
  pacman -Ss doom 2>/dev/null | grep -E "^(community|extra|core|cachyos)/" | head -10
}
step1

# ═══════════════════════════════════════════════════════════════
# STEP 2: Install doomretro and check for WAD files
# Generated: 2026-01-31 08:16:01
# ═══════════════════════════════════════════════════════════════
step2() {
    echo "=== Installing doomretro ==="
    sudo pacman -S --noconfirm doomretro
    echo ""
    echo "=== Checking for WAD files ==="
    find /usr/share -name "*.wad" -o -name "*.WAD" 2>/dev/null | head -20
    find ~ -name "*.wad" -o -name "*.WAD" 2>/dev/null | head -20
}
step2

# ═══════════════════════════════════════════════════════════════
# STEP 3: Launch Doom Retro with available WAD file
# Generated: 2026-01-31 08:16:10
# ═══════════════════════════════════════════════════════════════
step3() { doomretro -iwad /usr/share/doomretro/doomretro.wad; }
step3
